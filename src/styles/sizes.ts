...
export const BORDER_ROUND = widthPercentageToPx("7.5%");

export const colorBackgroundWhite = "#f7f7f7";

export const FONT_SIZE_PRIMARY = widthPercentageToPx("5.5%");
export const FONT_SIZE_PRIMARY_DP = widthPercentageToDP("5.5%");
export const FONT_SIZE_SECONDARY = widthPercentageToPx("3.4%");
export const FONT_SIZE_SECONDARY_DP = widthPercentageToDP("3.4%");
export const FONT_SIZE_TERTIARY = widthPercentageToPx("3.8%");
export const FONT_SIZE_TERTIARY_DP = widthPercentageToDP("3.8%");
export const FONT_SIZE_QUATERNARY = widthPercentageToPx("4.5%");
export const FONT_SIZE_QUATERNARY_DP = widthPercentageToDP("4.5%");
